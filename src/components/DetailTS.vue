<template>
   <div class="amazing-MN">
    <div class="container">
      <div class="row">
          <div class="col-lg-12">
          <div class="item-MN">
              <div class="col-lg-12">
                <div class="image"><img src="../../public/assets/images/Tuol_Sleng_M.jpg" alt="img01"></div>
              </div>
          ...
          <div class="col-lg-3 col-sm-12">
             <div class="item-MN">
                <div class="col-lg-12">
                  <div class="image"><img src="../../public/assets/images/TS02.jpg" alt="img01"></div>
                </div>
              </div>
          </div>
          ...
          <div class="col-lg-3 col-sm-12">
             <div class="item-MN">
                <div class="col-lg-12">
                  <div class="image"><img src="../../public/assets/images/TS01.jpg" alt="img01"></div>
                </div>
              </div>
          </div>
          ...
          <div class="col-lg-3 col-sm-12">
             <div class="item-MN">
                <div class="col-lg-12">
                  <div class="image"><img src="../../public/assets/images/TS03.jpg" alt="img01"></div>
                </div>
              </div>
          </div>
          ...
          <div class="col-lg-3 col-sm-12">
             <div class="item-MN">
                <div class="col-lg-12">
                  <div class="image"><img src="../../public/assets/images/TS04.jpg" alt="img01"></div>
                </div>
              </div>
          </div>
          <div class="main-button">
            <router-link to="/museum" class="nav-link">{{ $t("Return") }}</router-link>
          </div>
        </div>
      </div>
    </div>
